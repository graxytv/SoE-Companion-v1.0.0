...
pub struct UnitAny {
    ...
    pub mode: u32,        // 0x10: Unit mode (for items, 3 = on ground)
...
pub struct ItemData {
    ...
    pub _pad2: [u32; 4], // 0x1C-0x28 padding
    pub file_index: u32, // 0x2C: Index into UniqueItems.txt/SetItems.txt/items.txt
    pub _pad3: [u32; 6], // 0x30-0x44 padding
...
pub struct ScannedItem {
    ...
    pub class: u32,
    /// Item unit mode. Ground drops use mode 3.
    pub mode: u32,
    /// Item quality
    pub quality: u32,
    /// Item flags
    ...
    /// Whether item has the completed runeword flag
...
impl ScannedItem {
    pub fn from_unit(unit: &UnitAny, item_data: &ItemData, p_unit: u32) -> Self {
        Self {
            ...
            is_runeword: item_data.is_runeword(),
            name: None,
            stats: None,
