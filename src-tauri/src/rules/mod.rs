...
pub enum ItemTier {
    ...
    Angelic,
    Master,
    /// Sacred Unique — matches Unique drops classified as SU by UniqueItems.txt wLvl.
    Su,
    /// Sacred Set Unique — matches Unique drops classified as SSU by UniqueItems.txt wLvl.
    Ssu,
    /// Secret Sacred Set Unique — matches Unique drops classified as SSSU by UniqueItems.txt wLvl.
    Sssu,
}
